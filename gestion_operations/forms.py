...
class OperationForm(forms.ModelForm):
    ...
    date_ope = forms.DateField(widget=forms.SelectDateWidget(years=range(2017, 2022)))
    description = forms.CharField(widget=forms.Textarea)
...
class ImportCSVForm(forms.Form):
    file_path = forms.FilePathField(path="/Users/maxons/Documents/django_projects/Gestion_comptes_django/data")
